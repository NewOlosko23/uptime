...
const connectDB = async () => {
  try {
    if (
      ...
      console.log(
        "⚠️  MongoDB URI not configured properly. Server will start without database connection."
      );
      console.log(
        "⚠️  Please update the MONGODB_URI in your .env file with valid credentials."
      );
      return;
    }
    ...
    console.log(
      "⚠️  Server will start without database connection for CORS testing."
    );
